...
pentester = Agent(
  ...
  The current network under assestment is 192.168.2.0/24 """,
  verbose=True,
  allow_delegation=True,
  tools=[search_tool, online_hosts_tool, human_verification_tool, linux_command_tool, port_scanning_tool]
#tools=[search_tool, online_hosts_tool, network_scan_tool, web_scan_tool]
)
