...
MAX_TOKENS = 4096  # Maximum tokens for GPT-4, including prompt and response
...
def truncate_text_to_max_tokens(text, max_tokens=MAX_TOKENS):
    # Tokenize the text
...
def generate_profile_from_text(text, model="gpt-4"):
    try:
        prompt = (
        ...
        truncated_text = truncate_text_to_max_tokens(prompt)
